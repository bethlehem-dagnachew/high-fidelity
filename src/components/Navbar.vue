    ...
    <div class="container flex flex-wrap items-center justify-between mx-auto">
      <a href="#" class="flex items-center">
        ...
        <path
          ...
          <span class="uppercase self-center text-2xl font-bold whitespace-nowrap dark:text-[#781E2A]">Komuniti</span>
      </a>
      <img src="https://source.unsplash.com/75x75/?portrait" alt="" class="self-center flex-shrink-0 w-14 1-24 border rounded-full md:justify-self-start dark:bg-gray-500 dark:border-white-700 border-4 border-[#781E2A]">
